 ...
 * @returns
 */
const doRequest = (method, url, data, _header = DEFAULT_HEADERS, _showLoading = true) => {
  _showLoading && showLoading();
  return new Promise((resolve, reject) => {
    const headers = method === 'get' ? {} : _header;
    uni.request({
      url: `${API_PREFIX}/${url}`,
      data,
      headers,
 ...
 * @returns
 */
const get = (url, data, headers, showLoading) => {
  return doRequest('get', url, data, headers, showLoading);
};
 ...
 * @returns
 */
const post = (url, data, headers, showLoading) => {
  return doRequest('post', url, data, headers, showLoading);
};
